...
class NCGeneralizedFOLPythonParser(FOLPythonParser):
    def _is_quantification_expression_name(self, name: str) -> bool:
        return name in ['exists', 'forall', 'all', 'iota', 'miota', 'describe', 'execute', 'point', 'count', 'view']
